...
public class DBAdapter {
    ...
    private static final String TAG = "DBAdapter"; // for logging db version changes
    ...
    public static final int DATABASE_VERSION = 2; // version must be incremented each time a change to dB structure occurs
